...
config.window_background_opacity = 0.975  -- Slightly transparent background
...
-- --- Initial Window Size ---
config.initial_cols = 200  -- Default number of columns
config.initial_rows = 75  -- Default number of rows
